...
export const HALO_BUTTON_WATCHER_REGISTRY = Object.freeze([
  ...
  {
    id: "dreamweaver-lab-nav-show",
    label: "Dreamweaver Show (Song Lab nav)",
    pageRoute: "/dreamweaver-lab/",
    selector: 'nav a[href="/dreamweaver/"]',
    target: "/dreamweaver/",
    expectedBehavior: "Return to the Dreamweaver experience from Song Lab.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/dreamweaver", "/dreamweaver/index.html"]
  },
  {
    id: "dreamweaver-lab-nav-finish-house",
    label: "Finish House (Song Lab nav)",
    pageRoute: "/dreamweaver-lab/",
    selector: 'nav a[href="/finish-house/"]',
    target: "/finish-house/",
    expectedBehavior: "Open Finish House from Song Lab.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/finish-house"]
  },
  {
    id: "campaign-studio-nav-dreamweaver",
    label: "Dreamweaver (Campaign Studio nav)",
    pageRoute: "/campaign-studio/",
    selector: 'nav a[href="/dreamweaver/"]',
    target: "/dreamweaver/",
    expectedBehavior: "Return to Dreamweaver from Campaign Studio.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/dreamweaver", "/dreamweaver/index.html"]
  },
  {
    id: "campaign-studio-nav-release-house",
    label: "Release House (Campaign Studio nav)",
    pageRoute: "/campaign-studio/",
    selector: 'nav a[href="/release-house/"]',
    target: "/release-house/",
    expectedBehavior: "Open Release House from Campaign Studio.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/release-house"]
  },
  {
    id: "song-catalog-nav-release-house",
    label: "Release House (Song Catalog nav)",
    pageRoute: "/song-catalog/",
    selector: 'nav a[href="/release-house/"]',
    target: "/release-house/",
    expectedBehavior: "Open Release House from Song Catalog.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/release-house"]
  },
  {
    id: "song-catalog-nav-radio",
    label: "Radio (Song Catalog nav)",
    pageRoute: "/song-catalog/",
    selector: 'nav a[href="/radio/"]',
    target: "/radio/",
    expectedBehavior: "Open Radio from Song Catalog.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/radio", "/radio/index.html"]
  },
  {
  ...
  {
    id: "upload-pipeline-open-song-catalog",
    label: "Open Song Catalog (Upload Pipeline header)",
    pageRoute: "/upload-pipeline/",
    selector: 'a.primary-button[href="/song-catalog/"]',
    target: "/song-catalog/",
    expectedBehavior: "Open Song Catalog from Upload Pipeline.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/song-catalog", "/song-catalog/index.html"]
  },
  {
    id: "youtube-studio-nav-campaign-studio",
    label: "Campaign Studio (YouTube Studio nav)",
    pageRoute: "/youtube-studio/",
    selector: 'nav a[href="/campaign-studio/"]',
    target: "/campaign-studio/",
    expectedBehavior: "Return to Campaign Studio from YouTube Studio.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/campaign-studio", "/campaign-studio/index.html"]
  },
  {
    id: "youtube-studio-nav-dreamweaver",
    label: "Dreamweaver (YouTube Studio nav)",
    pageRoute: "/youtube-studio/",
    selector: 'nav a[href="/dreamweaver/"]',
    target: "/dreamweaver/",
    expectedBehavior: "Return to Dreamweaver from YouTube Studio.",
    ownerAgent: DASH_FIX_AGENTS.routing,
    legacyTargets: ["/dreamweaver", "/dreamweaver/index.html"]
  },
  {
