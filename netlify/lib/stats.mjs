...
export const allowedEvents = new Set([
  ...
  "album_concierge_cover_generated",
  "album_concierge_exported",
  "album_concierge_gifted",
  "album_concierge_premium_checkout",
  "album_concierge_premium_unlocked",
  "album_concierge_refined",
  "album_concierge_result_ready",
  "album_concierge_saved",
  "album_concierge_shared",
  "open_affiliate_gear",
