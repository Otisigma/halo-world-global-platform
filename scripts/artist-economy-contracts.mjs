...
assert.match(files.html, /id="statsBoardTitle"/);
assert.match(files.html, /id="statsKpiGrid"/);
assert.match(files.html, /id="statsRevenueTableBody"/);
...
assert.match(files.js, /renderStats/);
