...
const files = {
  ...
  routes: await readFile("lib/route-registry.js", "utf8")
};
...
assert.match(files.routes, /directoryRoute\("Artist Economy", "\/artist-economy\/", "artist-economy\/index\.html", \{ menuLabel: "ARTIST STATS" \}\)/);
