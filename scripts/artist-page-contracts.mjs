...
assert.match(artistStudio, /\/release-artwork\.css/);
assert.match(artistStudio, /\/release-artwork\.js/);
...
assert.match(artistScript, /uploadHelper\.uploadChunkedFile/);
assert.match(artistScript, /radioUploadUi/);
