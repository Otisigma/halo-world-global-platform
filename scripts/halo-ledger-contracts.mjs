...
const checks = [
  ...
  [ledgerHtml.includes('id="routeHealthTrends"') && ledgerHtml.includes('id="routeHealthSummary"') && ledgerHtml.includes('id="routeHealthHistory"'), "ledger HTML includes a dedicated route-health trends surface"],
  ...
  [ledgerCss.includes('[data-route-health-state="working"]') && ledgerCss.includes('[data-route-health-state="attention"]') && ledgerCss.includes('[data-route-health-state="broken"]') && ledgerCss.includes('[data-route-health-state="disconnected"]'), "ledger CSS visually distinguishes working/attention/broken/disconnected route-health states"],
  ...
  [ledgerJs.includes("fetchRouteHealthTrends") && ledgerJs.includes('category: "route_health"') && ledgerJs.includes("renderRouteHealthTrends"), "ledger JS loads and renders persisted route-health trends"],
  [ledgerJs.includes("ROUTE_HEALTH_STATES") && ledgerJs.includes("working") && ledgerJs.includes("attention") && ledgerJs.includes("broken") && ledgerJs.includes("disconnected"), "ledger JS preserves route-health state coverage in the trends surface"],
