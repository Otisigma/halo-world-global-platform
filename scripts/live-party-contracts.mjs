...
const checks = [
  ...
  [script.includes("/api/community") && script.includes('action: "message"') && script.includes('action: "report"') && script.includes('action: "control"'), "uses existing moderated community actions for live room interactions"],
