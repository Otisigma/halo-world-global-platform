...
assert.match(sweep, /run_live_connected_satellite_status/, "the maintenance team must label the one-command satellite workflow");
...
assert.match(api, /run_live_connected_satellite_status/, "owners must be able to trigger the one-command satellite sweep");
...
assert.match(client, /run_live_connected_satellite_status/, "the owner dashboard must trigger the one-command satellite sweep");
