...
assert.match(haloHome, /onLoadStart=\{\(\) => \{/, "the homepage Dreamweaver player must react to load-start events");
assert.match(haloHome, /onCanPlay=\{\(\) => \{/, "the homepage Dreamweaver player must react to ready-to-play events");
assert.match(haloHome, /onPlaying=\{\(\) => \{/, "the homepage Dreamweaver player must react to active playback events");
