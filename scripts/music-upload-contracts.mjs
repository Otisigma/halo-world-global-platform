...
const checks = [
  ...
  [/api\(\{action:"save_version",songId:\$\("#versionSongId"\)\.value,versionId:\$\("#versionId"\)\.value/.test(catalogClient), "keeps catalog version-save persistence used by the version editor flow"],
