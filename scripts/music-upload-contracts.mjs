...
const checks = [
  ...
  [catalogClient.includes("save_version"), "keeps catalog version-save persistence used by the version editor flow"],
  [catalogClient.includes("/api/song-catalog") && catalogClient.includes("/api/song-catalog/audio") && catalogClient.includes("/api/song-catalog/artwork"), "music upload surface is backed by existing catalog upload APIs"],
