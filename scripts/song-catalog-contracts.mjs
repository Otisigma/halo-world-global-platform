...
const checks = [
  ...
  [api.includes("publicationSync") && api.includes("publicationHealth") && api.includes("recheck_publication"), "exposes publication sync guidance and manual distributor rechecks through the song catalog API"],
  ...
  [page.includes("publicationHealthPanel") && page.includes("recheckPublicationButton") && page.includes("publicationChecklist"), "adds an artist-facing publication health desk with fix checklists"],
  [client.includes("renderPublicationHealth") && client.includes("publicationSurfaceList") && client.includes("recheckPublication"), "renders publication surfaces, reasons, and recheck controls in the catalog client"],
  [styles.includes("publication-health-panel") && styles.includes("publication-surface-item") && styles.includes("publication-agent-card"), "styles publication health status, surface readiness, and in-house distributor cards"],
