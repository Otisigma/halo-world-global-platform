...
const checks = [
  ...
  [page.includes('id="audioUploadTrack"') && page.includes('id="artworkUploadTrack"') && page.includes('id="versionArtworkTrack"') && client.includes("setUploadTrack"), "shows live upload progress tracks for audio and artwork uploads"],
