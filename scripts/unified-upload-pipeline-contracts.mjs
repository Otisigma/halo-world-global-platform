...
const checks = [
  ...
  [satelliteHelper.includes('params.set("mix"') && satelliteHelper.includes("satelliteRoute") && satelliteHelper.includes("dreamweaver-satellite-"), "shared Dreamweaver helper keeps deterministic storefront route, internal satellite path, and loop identity fields"],
  // Song catalog UI
