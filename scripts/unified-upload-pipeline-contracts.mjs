...
const checks = [
  ...
  [unifiedUploadFn.includes("dreamweaverSatellite") && unifiedUploadFn.includes("experienceUrl") && unifiedUploadFn.includes("/dreamweaver/satellite/") && unifiedUploadFn.includes("dreamweaver-satellite-"), "unified-upload returns deterministic per-song Dreamweaver satellite routing metadata and loop identity"],
