...
const checks = [
  ...
  [unifiedUploadFn.includes("buildDreamweaverSatellite") && routeRegistry.includes("experienceUrl") && routeRegistry.includes("/dreamweaver/") && routeRegistry.includes("dreamweaver-satellite-"), "unified-upload returns deterministic per-song Dreamweaver satellite routing and loop identity"],
