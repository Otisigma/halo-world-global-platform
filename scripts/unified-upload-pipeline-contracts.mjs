...
const checks = [
  ...
  [satelliteHelper.includes("resolveDreamweaverPageFlow") && satelliteHelper.includes("linked_song_pages") && satelliteHelper.includes("hub_loop") && dreamweaverManager.includes("dreamweaver-page-manager-") && dreamweaverManager.includes("/dreamweaver/?mix=") && dreamweaverManager.includes("pageAgent"), "shared satellite helper delegates to the Dreamweaver page manager and keeps linked-page channels wired with canonical hub routing"],
  // Song catalog UI
