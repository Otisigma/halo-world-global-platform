...
const checks = [
  ...
  [songCatalogFn.includes("dreamweaverSatellite") && songCatalogFn.includes("/dreamweaver/satellite/") && songCatalogFn.includes("canonicalDreamweaverUrl") && songCatalogFn.includes("dreamweaver-satellite-"), "song-catalog API serializes deterministic per-song Dreamweaver satellite metadata"],
  // Song catalog UI
