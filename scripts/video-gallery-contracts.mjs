...
const checks = [
  ...
  [djDeck.includes('id="boothVideoPresets"') && djDeck.includes('tabindex="0"') && djDeck.includes("Ghost To Me") && djDeck.includes("HALO Music World 50+") && djDeck.includes("DJ HALO X Long Mix Videos"), "keeps the named booth-screen video preset selectors on the DJ deck"],
