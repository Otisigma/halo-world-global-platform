...
const checks = [
  ...
  [djDeck.includes('elements.sessionRevisionButton?.addEventListener("click"') && djDeck.includes('showToast("Cloud revision"') && djDeck.includes('elements.maintenanceDock?.addEventListener("click"') && djDeck.includes('showToast("Maintenance alerts"'), "wires the new HUD dock actions into toast feedback"],
